...
@test "set by PHPENV_VERSION" {
  ...
  PHPENV_VERSION=1.9.3 run phpenv-version
  assert_success "1.9.3 (set by PHPENV_VERSION environment variable)"
}
...
@test "set by local file" {
  ...
  run phpenv-version
  assert_success "1.9.3 (set by ${PWD}/.php-version)"
}
...
@test "set by global file" {
  ...
  run phpenv-version
  assert_success "1.9.3 (set by ${PHPENV_ROOT}/version)"
}
